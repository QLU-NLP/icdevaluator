...
![equation](https://latex.codecogs.com/png.latex?\dpi{150} \small \text{Acc} = \frac{1}{N} \sum_{i=1}^{N} \left\{ 0.5 \cdot I(\hat{y}_{\text{main}} = y_{\text{main}}) + 0.5 \cdot F1(\hat{y}_{\text{other}}, y_{\text{other}}) \right\}_i
)
