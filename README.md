...
![equation](https://latex.codecogs.com/svg.image？\text{Acc}=\frac{1}{N}\sum_{i=1}^{N}\left\{0.5\cdot&space;I\hat{y}_{\text{main}}=y_{\text{main}}&plus;0.5\cdot&space;F1\hat{y}_{\text{other}}y_{\text{other}}\;\}_i)
