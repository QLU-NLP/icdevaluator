...
![F1公式](https://latex.codecogs.com/png.image?\dpi{150}F_1(y,\hat{y})=2\cdot\frac{\text{Precision}(y,\hat{y})\cdot\text{Recall}(y,\hat{y})}{\text{Precision}(y,\hat{y})+\text{Recall}(y,\hat{y})})
其中，
